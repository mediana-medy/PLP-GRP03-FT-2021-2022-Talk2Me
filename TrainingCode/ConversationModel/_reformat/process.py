...
strategies = json.load(open('C:/Users/User/PycharmProjects/Emotional-Support-Conversation/strategy.json'))
strategies = [e[1:-1] for e in strategies]
strat2id = {strat: i for i, strat in enumerate(strategies)}
original = json.load(open('C:/Users/User/PycharmProjects/Emotional-Support-Conversation/ESConv.json', encoding='utf8'))
